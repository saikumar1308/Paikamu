...
export const Appbar = ({
    ...
    return <nav className="bg-orange-400 border-gray-200 bg-orange-400">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="http://localhost:3001/dashboard" className="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="https://www.svgrepo.com/download/479217/rupee-1-frame.svg" className="h-8" alt="Paikamu Logo" />

                <span className="self-center text-2xl font-semibold whitespace-nowrap ">Paikamu</span>
            </a>
            ...
            <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ">
                    ...
                    <li>
                        <a href="#" onClick={user ? onSignout : onSignin} className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 bg-orange-500 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 ">{user ? "Logout" : "Login"}</a>
                    </li>
                </ul>
            </div>
        </div>
